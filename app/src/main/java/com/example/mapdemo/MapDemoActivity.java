...
public class MapDemoActivity extends AppCompatActivity implements
	...
	private long UPDATE_INTERVAL = 1200000;  /* 60 secs */
	private long FASTEST_INTERVAL = 5000; /* 5 secs */

	static final String TAG = MapDemoActivity.class.getSimpleName();
    ...
    protected void loadMap(GoogleMap googleMap) {
        map = googleMap;
        if (map != null) {
			// Attach listeners to the map here
		...
		alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, "OK",
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						BitmapDescriptor icon = MapUtils.createBubble(MapDemoActivity.this, IconGenerator.STYLE_BLUE, title);
